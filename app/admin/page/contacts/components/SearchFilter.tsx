...
import {SearchFilterProps}from '../types/index'

export const SearchFilter = ({ searchTerm, setSearchTerm, statusFilter, setStatusFilter, isDarkMode, isArabic }: SearchFilterProps) => (
