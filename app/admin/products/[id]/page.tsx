        ...
        <div className={`rounded-xl shadow-lg mb-4 sm:mb-6 overflow-hidden ${isDarkMode ? 'bg-gradient-to-r from-blue-900 to-blue-800' : 'bg-gradient-to-r from-blue-600 to-blue-500'}`}>
          <div className="p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <div>
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-1">✏️ {isArabic ? 'تعديل المنتج' : 'Edit Product'}</h1>
                <p className="text-sm sm:text-base text-blue-100">{isArabic ? 'تحديث معلومات المنتج' : 'Update product information'}</p>
              </div>
              <button 
                onClick={() => router.back()} 
