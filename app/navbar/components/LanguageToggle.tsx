...
import {LanguageToggleProps}from '../types/navbar.types'
...
export const LanguageToggle = ({ language, toggleLanguage, isArabic, isDarkMode }: LanguageToggleProps) => {
  return (
    <motion.button
      ...
      className={`flex items-center gap-1 px-3 py-2 text-sm font-medium cursor-pointer border rounded-lg transition-all ${
        isDarkMode 
