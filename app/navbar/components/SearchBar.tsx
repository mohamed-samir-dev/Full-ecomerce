  ...
  return (
    <div className={`relative ${isMobile ? 'w-full' : 'w-full'}`}>
      ...
      <input
        ...
        className={`block w-full ${isArabic ? 'pr-10 pl-4' : 'pl-10 pr-4'} py-2.5 border rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-text ${
          isDarkMode 
