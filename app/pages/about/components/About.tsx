      ...
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          <div className="p-4 sm:p-6 rounded-xl text-center bg-white shadow-md hover:scale-105 transition-transform">
            ...
            <h3 className="text-base sm:text-lg font-bold mb-2 text-gray-900">{t('about.features.quality')}</h3>
            <p className="text-xs sm:text-sm text-gray-600">{t('about.features.qualityDesc')}</p>
          </div>
          
          <div className="p-4 sm:p-6 rounded-xl text-center bg-white shadow-md hover:scale-105 transition-transform">
            <div className="text-4xl sm:text-5xl mb-3 sm:mb-4">🚀</div>
            <h3 className="text-base sm:text-lg font-bold mb-2 text-gray-900">{t('about.features.shipping')}</h3>
            <p className="text-xs sm:text-sm text-gray-600">{t('about.features.shippingDesc')}</p>
          </div>
          
          <div className="p-4 sm:p-6 rounded-xl text-center bg-white shadow-md hover:scale-105 transition-transform">
            <div className="text-4xl sm:text-5xl mb-3 sm:mb-4">💎</div>
            <h3 className="text-base sm:text-lg font-bold mb-2 text-gray-900">{t('about.features.prices')}</h3>
            <p className="text-xs sm:text-sm text-gray-600">{t('about.features.pricesDesc')}</p>
          </div>
          
          <div className="p-4 sm:p-6 rounded-xl text-center bg-white shadow-md hover:scale-105 transition-transform">
            <div className="text-4xl sm:text-5xl mb-3 sm:mb-4">🔒</div>
            <h3 className="text-base sm:text-lg font-bold mb-2 text-gray-900">{t('about.features.secure')}</h3>
            <p className="text-xs sm:text-sm text-gray-600">{t('about.features.secureDesc')}</p>
          </div>
        </div>
      </div>
