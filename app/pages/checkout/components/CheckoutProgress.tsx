    ...
    >
      <div className="flex items-center justify-center">
        <div className="flex items-center">
          ...
          >
            <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center font-bold shadow-lg ${
              currentStep >= 1 ? 'bg-linear-to-r from-blue-600 to-blue-500 text-white' : 'bg-gray-200 text-gray-600'
            }`}>
        ...
        <div className="flex items-center">
          ...
          >
            <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center font-bold shadow-lg ${
              currentStep >= 2 ? 'bg-linear-to-r from-purple-600 to-purple-500 text-white' : 'bg-gray-200'
            }`}>
              2
            </div>
            <span className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 text-xs sm:text-sm font-medium whitespace-nowrap text-gray-700">
