    ...
    <div className="rounded-2xl shadow-lg p-4 sm:p-6 border bg-linear-to-r from-blue-50 to-purple-50 border-blue-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
        <div className="flex items-start">
          ...
          <div>
            <p className="font-semibold text-xs sm:text-sm text-gray-800">3-5 Business Days</p>
        ...
        <div className="flex items-start">
          ...
          <div>
            <p className="font-semibold text-xs sm:text-sm text-gray-800">Free Shipping</p>
        ...
        <div className="flex items-start">
          ...
          <div>
            <p className="font-semibold text-xs sm:text-sm text-gray-800">Secure Packaging</p>
            <p className="text-xs text-gray-600">Protected delivery</p>
          </div>
        </div>
      </div>
    </div>
