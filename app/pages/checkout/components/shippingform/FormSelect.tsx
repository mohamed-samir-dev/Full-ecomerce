  ...
  return (
    <div>
      ...
      <select
        ...
        className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base border-2 rounded-xl focus:outline-none focus:border-blue-500 transition-colors ${isDarkMode ? 'bg-[#191C21] border-slate-600 text-white' : 'bg-white border-gray-200 text-black'}`}
      >
