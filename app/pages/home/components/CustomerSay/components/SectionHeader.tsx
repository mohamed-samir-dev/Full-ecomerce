  ...
  return (
    <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
      ...
      {isLoggedIn ? (
        <button
          onClick={onOpenForm}
          className={`inline-flex items-center gap-1.5 sm:gap-2 px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full text-sm sm:text-base font-medium transition-all shadow-sm ${
            isDarkMode 
              ? 'bg-gray-700 text-white hover:bg-gray-600 border border-gray-600' 
              : 'bg-white text-[#0D0D0D] hover:bg-gray-50 border border-gray-200'
          }`}
        >
